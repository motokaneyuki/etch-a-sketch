# etch-a-sketch
Live preview can be found <a href="https://motokaneyuki.github.io/etch-a-sketch/">here</a>.
...
- DOM methods
- How to generate new elements using javascript, creating in bulk
- Use flexbox to make divs appear as a grid
- How to clear out old elements before injecting new ones
- Event listeners on buttons and other items
- How to use mousedown and mouseup
- Difference of mouseover and mousemove
